...
struct SettingsCardControl : SettingsCardControlT<SettingsCardControl>
{
    SettingsCardControl()
    {
        DefaultStyleKey(winrt::box_value(L"CppWinUIGallery.SettingsCardControl"));
    }
    ...
    static void OnRightSideContentChanged(Microsoft::UI::Xaml::DependencyObject const &d,
    ...
    static void OnSubtitleChanged(Microsoft::UI::Xaml::DependencyObject const &d,
                                  Microsoft::UI::Xaml::DependencyPropertyChangedEventArgs const &);
    ...
    static void OnIconChanged(Microsoft::UI::Xaml::DependencyObject const &d,
                              Microsoft::UI::Xaml::DependencyPropertyChangedEventArgs const &);
