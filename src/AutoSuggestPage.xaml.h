...
struct AutoSuggestPage : AutoSuggestPageT<AutoSuggestPage>
{
  private:
    std::vector<std::string> ElementsList = {
        ...
        "Blueberry", "Raspberry",    "Blackberry",    "Cherry",       "Watermelon", "Cantaloupe", "Honeydew",
        "Kiwi",      "Papaya",       "Pomegranate",   "Peach",        "Plum",       "Apricot",    "Nectarine",
        "Fig",       "Date",         "Grapefruit",    "Lemon",        "Lime",       "Avocado",    "Coconut",
        "Lychee",    "Guava",        "Passion Fruit", "Dragon Fruit", "Jackfruit",  "Durian",     "Persimmon",
        "Cranberry", "Mulberry",     "Gooseberry",    "Starfruit",    "Tamarind",   "Kumquat",    "Clementine",
        "Tangerine", "Blood Orange", "Quince",        "Medlar",       "Soursop",    "Mangosteen", "Rambutan",
        "Longan"};

    bool isTextBoxEmpty = true;

    winrt::Microsoft::UI::Xaml::Controls::AutoSuggestBox myTemplatedSearchBox;
  ...
  public:
    ...
    void SearchBox_KeyDown(winrt::Windows::Foundation::IInspectable const &sender,
                           winrt::Microsoft::UI::Xaml::Input::KeyRoutedEventArgs const &e);
    void SearchBox_GotFocus(winrt::Windows::Foundation::IInspectable const &sender,
                            winrt::Microsoft::UI::Xaml::RoutedEventArgs const &e);
    void SearchBox_LostFocus(winrt::Windows::Foundation::IInspectable const &sender,
                             winrt::Microsoft::UI::Xaml::RoutedEventArgs const &e);
