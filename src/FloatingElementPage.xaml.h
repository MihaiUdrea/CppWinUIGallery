...
struct FloatingElementPage : FloatingElementPageT<FloatingElementPage>
{
    ...
    void ScrollViewer_ViewChanged(winrt::Windows::Foundation::IInspectable const &sender,
  ...
  public:
    void DoubleAnimation_Completed(winrt::Windows::Foundation::IInspectable const &sender,
