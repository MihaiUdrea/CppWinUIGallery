...
void AutoSuggestPage::SearchBox_TextChanged(
...
void AutoSuggestPage::SearchBox_KeyDown(winrt::Windows::Foundation::IInspectable const &sender,
...
void AutoSuggestPage::SearchBox_GotFocus(winrt::Windows::Foundation::IInspectable const &sender,
...
void AutoSuggestPage::SearchBox_LostFocus(winrt::Windows::Foundation::IInspectable const &sender,
                                          winrt::Microsoft::UI::Xaml::RoutedEventArgs const &e)
{
    auto mySearchBox = SearchBox();
    auto overlayIcon = searchIconOverlay();
...
void AutoSuggestPage::SearchBox_QuerySubmitted(
    winrt::Microsoft::UI::Xaml::Controls::AutoSuggestBox const &sender,
...
void AutoSuggestPage::ShowHideButton_Click(winrt::Windows::Foundation::IInspectable const &sender,
                                           winrt::Microsoft::UI::Xaml::RoutedEventArgs const &e)
{
...
void AutoSuggestPage::ShowCppButton_Click(winrt::Windows::Foundation::IInspectable const &sender,
                                          winrt::Microsoft::UI::Xaml::RoutedEventArgs const &e)
{
    ...
    if (textBox.Visibility() == Visibility::Collapsed)
    {
        ...
        // Show C++ source code
        hstring cppSourceCode =
            LR"(bool AutoSuggestPage::isSubstring(const std::string& mainString, const std::string& subString)
    {
        // using find method to check if subString is
        // a substring of mainString
